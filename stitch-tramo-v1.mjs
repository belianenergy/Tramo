...
const PROMPT_FILE = "STITCH_PROMPT_TRAMO_V1.md";
const PREFIX = "stitch-tramo-v1";
const PROJECT_TITLE = "Tramo — Market Launch Front V1";
...
const screens = [
  {
    ...
    focus:
      "Create only page 1: public landing for Tramo. Include hero, pain triptych, system flow, module grid, product proof and compact pilot qualification CTA.",
  },
  {
    key: "dashboard",
    title: "Portfolio Dashboard",
    focus:
      "Create only page 2: portfolio dashboard. Show KPIs, consumption by reservation state, action queue and property summary.",
  },
  {
    key: "operations",
    title: "Operations Queue",
    focus:
      "Create only page 3: operations queue. Show filters, alert rows with evidence and a detail panel for one selected alert.",
  },
  {
    key: "apartments",
    title: "Apartments Portfolio",
    focus:
      "Create only page 4: apartments portfolio. Show table/cards with property code, owner, occupancy, kWh/stay, non-operational kWh and status.",
  },
  {
    key: "tariff-power",
    title: "Tariff and Power",
    focus:
      "Create only page 5: tariff and contracted power module. Show current vs recommended P1/P2, tariff review, evidence and prudent estimated impact.",
  },
  {
    key: "owner-report",
    title: "Owner Report",
    focus:
      "Create only page 6: owner-facing monthly report. Show kWh, non-operational consumption, actions performed, estimated impact and ready-to-send summary.",
  },
  {
    key: "leads",
    title: "Pilot Leads CRM",
    focus:
      "Create only page 7: internal pilot leads CRM. Show units, PMS, Datadis/factura availability, main pain, interests and status.",
  },
  {
    key: "pilot-settings",
    title: "Pilot Settings",
    focus:
      "Create only page 8: pilot settings and integrations. Show PMS, CUPS/Datadis, invoices/CSV, appliances, thresholds and notification rules.",
  },
];
...
Return one complete responsive desktop web screen. Keep visual language consistent with the other Tramo screens. Do not include pages other than the requested page.

Every screen must use the Tramo brand, not EnergyOS. Every screen must obey the cream/ink/orange identity and show concrete energy data with units.`;
}
...
for (const screen of screens) {
  ...
  if (
    !ONLY_PAGES.length &&
    summary.screens[screen.key]?.localFiles?.html &&
    fs.existsSync(summary.screens[screen.key].localFiles.html)
  ) {
