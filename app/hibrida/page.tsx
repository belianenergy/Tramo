...
const howSteps = [
  ...
  { step: '02', title: 'Detectamos margen perdido', body: 'Cruzamos consumo, ocupación y periodos tarifarios.', metric: '14 días', tag: 'Curva real', color: '#f59e0b', chipBg: '#fef3c7' },
  { step: '03', title: 'Apruebas acciones', body: 'Recibes prioridad económica e informe por propietario.', metric: '€/mes', tag: 'Decisión diaria', color: '#2563eb', chipBg: '#dbeafe' },
];
