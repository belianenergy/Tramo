...
const PREFIX = 'stitch-mvp-completo-v1';
const PROJECT_TITLE = 'EnergyOS MVP Completo — Gestoras Apartamentos Turísticos';
...
function screenPrompt(screen) {
  return `${fullPrompt}\n\n---\n\n# Tarea concreta para esta llamada\n\n${screen.focus}\n\nNombre interno sugerido de la pantalla: ${screen.name}\nTítulo visible/metadata: ${screen.title}\n\nRepite la navegación común del MVP para que parezca parte del mismo producto. Mantén consistencia visual con las demás pantallas. Devuelve una pantalla desktop responsive en modo claro.`;
}
